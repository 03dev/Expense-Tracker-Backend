...
const dashboardData = async (req: AuthenticatedRequest, res: Response) => {
    ...
    const { totalBalance, totalIncome, totalExpense, recentTransactions, topCategories} = await DashboardService.getDashboardDataService(userId, query.month, query.year);
